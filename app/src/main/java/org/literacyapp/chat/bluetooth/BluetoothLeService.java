...
public class BluetoothLeService extends Service {
    ...
    private static final String LITERACY_APP_UUID = "00002a37-0000-1000-8000-00805f9b34fb";
    private static final String CHAT_MESSAGE_STATE = "0000180a-0000-1000-8000-00805f9b34fb";
    ...
    public void addDefinedGattServerServices() {
        ...
        BluetoothGattService service = new BluetoothGattService(UUID.fromString(LITERACY_APP_UUID), BluetoothGattService.SERVICE_TYPE_PRIMARY);

        BluetoothGattCharacteristic characteristic = new BluetoothGattCharacteristic(UUID.fromString(CHAT_MESSAGE_STATE), BluetoothGattCharacteristic.FORMAT_UINT8, BluetoothGattCharacteristic.PERMISSION_WRITE);
